...
vim.keymap.set('n', '<leader>pv', vim.cmd.Neotree, { desc = 'Open file explorer' })
...
local devPath = vim.fn.stdpath 'config' .. '/my/'
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- TODO: map('<leader>pp', '<CMD>lua MyMenu()<CR>', 'Open my project list')
